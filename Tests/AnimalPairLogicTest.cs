namespace Tests
{
    ...
    public class AnimalPairLogicTest
    {
        ...
        [Fact]
        public void AnimalPairsCreated_AnimalsInListDontHavePropertiesSet_ThrowException()
        {
            var animals = new List<Animal>
            {
                new Animal(),
            ...
            var action = () => pairLogic.AnimalPairsCreated();
        ...
        [Fact]
        public void AnimalPairsCreated_AnimalPairDontHaveNextPositionSet_ThrowException()
        {
            var animals = new List<Animal>
            {
                new Antelope {CurrentPosition = new Coordinates { X = 6, Y = 7 } },
